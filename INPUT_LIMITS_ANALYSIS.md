...
> **최신 변경**: v0.3.3 입력 시스템 개선 (prompt-toolkit, Python 3.12 지원)
...
| **Q&A 응답 (다국어)** | 10개 (원본) + 10개 (번역) | QA Agent Dual Query (v0.3.2+) |
| **일반 쿼리** | 5개 (기본) | 기타 |
...
| 날짜 | 버전 | 변경 내용 |
|-----|------|----------|
| 2026-02-08 | 1.0.0 | 초기 문서 작성 |
| 2026-02-09 | 1.3.0 | Config 기반 설정 반영 (15+ 환경변수) |
| 2026-02-10 | 1.4.0 | 멀티소스 전략 추가 |
| 2026-02-12 | 1.6.0 | v0.2.6 이미지 버그 수정 반영 |
| 2026-02-12 | 2.0.0 | 대폭 간소화: 핵심 정보만 정리 |
| 2026-02-12 | 2.1.0 | v0.2.7 반영: 예외 처리, 프롬프트 관리 |
| 2026-02-12 | 3.0.0 | v0.3.0 반영: 슬라이드 최적화, Mermaid 다이어그램 |
| 2026-02-14 | 3.2.0 | v0.3.2 반영: 다국어 지원, RAG 품질 강화 |
| 2026-02-15 | **3.3.0** | **v0.3.3 반영**: 입력 시스템 개선, Python 3.12 지원 |

---

**최종 수정**: 2026-02-15 (v3.3.0)
