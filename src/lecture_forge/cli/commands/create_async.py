...
async def generate_lecture_async(inputs: Dict) -> Dict:
    ...
    with Progress(
        ...
        task1 = progress.add_task(
            "[cyan]📚 Phase 1: Collecting content (async)...", total=1
        )
        ...
        task5 = progress.add_task(
            f"[cyan]✅ Phase 5: Quality assurance (threshold: {quality_threshold})...", total=1
        )
        ...
        task6 = progress.add_task("[cyan]🎨 Phase 6: Assembling HTML...", total=1)
