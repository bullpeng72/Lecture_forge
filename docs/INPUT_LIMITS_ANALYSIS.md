...
> **최종 수정**: 2026-04-17 (v0.5.9)
> **목적**: 각 입력 소스의 제한사항과 실제 활용량 정리
> **최신 변경**: v0.5.9 이미지 단일 저장·배포 구조 개선, v0.5.8 이미지 번들링·커버리지 균형 개선, v0.5.7 미사용 import 정리, v0.5.6 PDFImageDescriber·TokenTracker Ollama 호환, v0.5.5 CLI 안정성·Ollama 지원, v0.5.4 테스트 커버리지 강화(81%)
