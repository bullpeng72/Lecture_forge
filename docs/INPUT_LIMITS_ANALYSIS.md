...
> **최종 수정**: 2026-04-27 (v0.6.3)
> **목적**: 각 입력 소스의 제한사항과 실제 활용량 정리
> **최신 변경**: v0.6.3 `--config` 디렉토리 거부 수정 + CLI 문서 보완; v0.6.2 agent-evaluator 0.9.0 의존성 정비 (pipx 수정); v0.6.1 agent-evaluator 계측 통합 (opt-in) + openai SDK v2 지원
