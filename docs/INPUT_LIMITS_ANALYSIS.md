...
> **최종 수정**: 2026-04-13 (v0.5.5)
> **목적**: 각 입력 소스의 제한사항과 실제 활용량 정리
> **최신 변경**: v0.5.5 CLI 안정성·도움말 현행화, v0.5.4 테스트 커버리지 강화(81%)·techdebt 개선, v0.5.3 패키징 안정화·슬라이드 타이틀 개선, v0.5.0 웹 편집기, v0.4.1 translate 명령어
