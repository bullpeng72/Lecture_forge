...
> **최종 수정**: 2026-04-03 (v0.5.3)
> **목적**: 각 입력 소스의 제한사항과 실제 활용량 정리
> **최신 변경**: v0.5.3 패키징 안정화·슬라이드 타이틀 개선, v0.5.2 BaseAgent max_tokens·RMC 루프 상한·다이어그램 병렬 생성·검색 전체 페이지 병렬 fetch, v0.5.0 웹 편집기, v0.4.1 translate 명령어
